...
router.get('/api/tabList/1/data/1', function (req, res, next) {
    res.send({
        code: 0,
        data: {
            funTabList: [
...
//发送短信验证码
router.post('/api/smscode', function (req, res, next) {
    /*res.send({
        code:200,
        data:{
            success:true,
...
//添加地址
router.post('/api/addOrEditAddress', function (req, res, next) {
...
//更新订单状态
router.post('/api/updateOrder', function (req, res, next) {
    let orderID = req.body.data.orderID;
